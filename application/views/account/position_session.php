                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>account/position/semester/<?php echo htmlentities($sch->row()->School_mark);?>/<?php echo htmlentities($type->Session);?>/<?php echo htmlentities($type->Term);?>">View Positon</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
