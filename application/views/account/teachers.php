                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>account/teachers/view_teachers/<?php echo htmlentities($sch->row()->School_mark);?>">View Teachers</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('account/teachers/create_teacher');?>
                ...
                <div class="modal fade" id="deleteall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open('account/teachers/delete_teacher_all');?>
