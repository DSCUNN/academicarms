                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        <a href="<?php echo base_url();?>account/subject_combination"><button class="btn btn-secondary" style="margin-right:4px;" data-toggle="modal" data-target="#addschooltype"><i class="ti-plus"></i> Add</button></a>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>account/subject_combination/view_combinations/<?php echo htmlentities($class->row()->ClassRef);?>">View Subjects</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
