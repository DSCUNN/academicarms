                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        <a href="<?php echo base_url();?>account/grade"><button class="btn btn-secondary" style="margin-right:4px;"><i class="ti-plus"></i> Add</button></a>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered w-100" id="dt-filter">
                                        ...
                                        <tbody>
                                        	...
                                        	$cnt++;
                                        	$sch=$this->Organizer_model->get_school_id($grade->School_id,$grade->OrganizerId);
                                        	?>
                                            <tr>
                                                <td><?php echo $cnt;?></td>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#edit_schooltype" data-value="<?php echo htmlentities($grade->Grade_id);?>">Edit Grade</a>
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#delete_schooltype" data-value="<?php echo htmlentities($grade->Grade_id);?>">Delete</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('account/grade/edit_grade');?>
                                            <div class="row" id="form">
                                                ...
                                                <div class="col-sm-12 form-group mb-4">
                                                    <input class="form-control" type="text" placeholder="Grade" name="name">
                                                </div>
                                                 <div class="col-sm-12 form-group mb-4">
                                                    <input class="form-control" type="text" placeholder="Minimum Score" name="min_score">
                                                </div>
                                                 <div class="col-sm-12 form-group mb-4">
                                                    <input class="form-control" type="text" placeholder="Maximum Scroe" name="max_score">
                                                </div> <div class="col-sm-12 form-group mb-4">
                                                    <input class="form-control" type="text" placeholder="Grade Point" name="point">
                                                </div>
                                                 <div class="col-sm-12 form-group mb-4">
                                                ...
                                                <div class="col-sm-12 form-group mb-4" style="display: none;">
                                                    <input class="form-control" type="text" placeholder="Class Id" name="id">
                                                </div>
                                                <div class="col-sm-12 form-group mb-4">
                                                    <label>Status</label>
                ...
                <div class="modal fade" id="delete_schooltype" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open('account/grade/delete_grade');?>
