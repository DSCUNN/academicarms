                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        <a href="<?php echo base_url();?>account/teachers"><button class="btn btn-secondary" style="margin-right:4px;"><i class="ti-plus"></i> Add</button></a>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered w-100" id="dt-filter">
                                        ...
                                        <tbody>
                                        	...
                                        	$cnt++;
                                        	$sch=$this->Organizer_model->get_school_id($teacher->School_id,$teacher->OrganizerId);
                                            $class=$this->Organizer_model->get_class_id($teacher->Class,$teacher->OrganizerId);
                                        	?>
                                            <tr>
                                                <td><?php echo $cnt;?></td>
                                                ...
                                                <td>
                                                    <?php 
                                                    if ($teacher->Class==0):?>
                                                    <span class="badge badge-warning badge-pill">Class Not Assigned</span>
                                                    <?php else:?>
                                                        <span class="badge badge-primary badge-pill"><?php echo htmlentities($class->row()->Name);?></span>
                                                    <?php endif;?>
                                                </td>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#edit_schooltype" data-value="<?php echo htmlentities($teacher->Teacher_id);?>">Edit Teacher</a>
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#delete_schooltype" data-value="<?php echo htmlentities($teacher->Teacher_id);?>">Delete</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('account/teachers/edit_teacher');?>
                                            <div class="row" id="form">
                                                ...
                                                <div class="col-sm-12 form-group mb-4" style="display: none;">
                                                    <input class="form-control" type="text" placeholder="Teacher Id" name="id">
                                                </div>
                                            </div>
                ...
                <div class="modal fade" id="delete_schooltype" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open('account/teachers/delete_teacher');?>
