            ...
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div class="font-18 text-center">Email Verification</div>
                    </div>
                    <?php echo form_open('','id="register-form"');?>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" id="password" type="password" name="code"><label>Code</label></div>
                        </div>
                       <button class="btn btn-primary btn-rounded btn-block" type="submit">Verify</button>
                    <?php echo form_close();?>
                </div>
