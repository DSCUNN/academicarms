...
<head>
    ...
    <title><?php echo $general_settings->row()->Site_name;?> || <?php echo $Page_name;?></title><!-- GLOBAL VENDORS-->
...
<body>
        ...
        <div class="auth-wrapper">
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    ...
                    <div class="alert alert-primary" role="alert">We have stopped Registration. Please check back later</div>
                    <?php endif;?>
                    <?php 
                    ...
                    <div class="text-center mb-5">
                        <h3 class="mb-3 text-primary"><img src="<?php echo base_url();?>assets/dashboard/logo/<?php echo $general_settings->row()->Site_logo;?>"></h3>
                        <div class="font-18 text-center">Create an account</div>
                    </div>
                    <?php echo form_open('register/create_account','id="register-form"');?>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="text" name="name"><label>Name</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="email" name="email"><label>Email</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="text" name="username"><label>Username</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" id="password" type="password" name="password"><label>Password</label></div>
                        </div>
                        <div class="mb-5">
                            <div class="md-form mb-0"><input class="md-form-control" type="password" name="password_confirmation"><label>Confirm Password</label></div>
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            toastr["info"]("You may be required to verify your email so use a functional email to register", "Registration Message")
            toastr.options = {
              "closeButton": true,
              "debug": false,
              "newestOnTop": false,
