            ...
            <div>
                <div class="card">
                    ...
                    <div class="card-body pt-1">
                        ...
                        <?php } ?>
                        <!--//SHOWING MESSAGE{SUCCESS OR FAILURE}-->
                            <div class="md-form mb-0"><input class="md-form-control" type="password" name="new_password"><label>New Password</label></div><div class="md-form mb-0"> <input class="md-form-control" type="password" name="confirm_password"><label>Confirm New Password</label></div><button class="btn btn-primary btn-rounded btn-block mt-4">SUBMIT</button>
                        <?php echo form_close();?>
                    </div>
                </div>
