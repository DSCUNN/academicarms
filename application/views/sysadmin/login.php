        ...
        <div class="auth-wrapper">
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    ...
                    <?php echo form_open('sysadmin/login/authenticate','id="register-form"');?>
                        <div class="mb-4">
                       ...
                       <div class="flexbox mb-5"><label class="ui-switch switch-solid"><input type="checkbox" checked=""><span class="ml-0"></span> Remember Me</label><a href="<?php echo base_url();?>sysadmin/login/forgotpassword">Forgot password?</a></div><button class="btn btn-primary btn-rounded btn-block" type="submit">LOGIN</button>
                    <?php echo form_close();?>
                </div>
