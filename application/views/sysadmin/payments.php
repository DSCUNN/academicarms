                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($status==1):?>
                                                        <a class=" font-16 btn btn-sm btn-warning" href="<?php echo base_url();?>sysadmin/payments/set_status/<?php echo htmlentities($key->Payment_id);?>/3" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Deactivate"><i class="ti-lock"></i></a>
                                                         <a class=" font-16 btn btn-sm btn-secondary" href="<?php echo base_url();?>sysadmin/payments/set_status/<?php echo htmlentities($key->Payment_id);?>/2" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Cancel"><i class="ti-lock"></i></a>
                                                    <?php else:?>
                                                        <a class=" font-16 btn btn-sm btn-success" href="<?php echo base_url();?>sysadmin/payments/set_status/<?php echo htmlentities($key->Payment_id);?>/1" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Mark Successful"><i class="ti-unlock"></i></a>
                                                         <a class=" font-16 btn btn-sm btn-secondary" href="<?php echo base_url();?>sysadmin/payments/set_status/<?php echo htmlentities($key->Payment_id);?>/2" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Cancel"><i class="ti-lock"></i></a>
                                                    <?php endif;?>
                                                    <a class=" font-16 btn btn-sm btn-danger" href="<?php echo base_url();?>sysadmin/payments/delete/<?php echo htmlentities($key->Payment_id);?>/" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Delete"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
                                        </tbody>
