                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        <a href="<?php echo base_url();?>teachers/position"><button class="btn btn-secondary" style="margin-right:4px;"><i class="ti-plus"></i> Add</button></a>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>teachers/position/type/<?php echo htmlentities($sch->row()->School_mark);?>/<?php echo htmlentities($type->Session);?>/<?php echo htmlentities($type->Term);?>/<?php echo htmlentities($type->Class);?>/<?php echo htmlentities($type->Student);?>/<?php echo htmlentities($type->Result_type);?>">View Positon</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
