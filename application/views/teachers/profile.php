                    ...
                    <div >
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="card">
                                    <div class="card-body text-center"><span class="position-relative d-inline-block my-4"><img class="rounded-circle" src="<?php echo base_url();?>assets/dashboard/assets/img/users/<?php echo htmlentities($teacher->Photo);?>" alt="image" width="120" /><span class="badge-point badge-success avatar-badge" style="bottom: 5px;right: 14px;height: 14px;width: 14px;"></span></span>
                                        <div class="h4"><?php echo htmlentities($teacher->Name);?></div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-4">
                                            <h5 class="box-title mb-0">Information</h5><a href="<?php echo base_url();?>teachers/accounts"><i class="ti-pencil"></i> Edit</a>
                                        </div>
                                        <?php 
                                        $name=$teacher->Name;
                                        $names=explode(' ', $name);?>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6"><?php echo htmlentities($teacher->Email);?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
