                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        <?php
                                        if ($school_exists->Teacher_add_result==1):?>
                                        <a href="<?php echo base_url();?>teachers/results"><button class="btn btn-secondary" style="margin-right:4px;"><i class="ti-plus"></i> Add</button></a>
                                    <?php endif;?>
                                    </div>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <a class="dropdown-item" href="<?php echo base_url();?>teachers/results/student/<?php echo htmlentities($school_exists->School_mark);?>/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>/<?php echo htmlentities($result->Class);?>/<?php echo htmlentities($result->Student);?>">View Results</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
