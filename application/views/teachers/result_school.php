                            ...
                            <div class="card-body">
                                ...
                                <div class="flexbox mb-4">
                                    <div class="flexbox">
                                        ...
                                        <?php
                                        if ($school_exists->Result_type==1):?>
                                            <a href="<?php echo base_url();?>teachers/position"><button class="btn btn-primary" style="margin-right:4px;"><i class="ti-file"></i> Add Position</button></a>
                                        <?php endif;?>
                                    <?php endif;?>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>teachers/results/session/<?php echo htmlentities($school->row()->School_mark);?>/<?php echo htmlentities($result->Session);?>">View Results</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('teachers/results/create');?>
