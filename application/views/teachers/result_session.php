                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>teachers/results/semester/<?php echo htmlentities($school_exists->School_mark);?>/<?php echo htmlentities($result->Session);?>/<?php echo htmlentities($result->Semester);?>">View Results</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
