                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="dropdown-item" href="<?php echo base_url();?>teachers/subject_combination/view_subject_class/<?php echo htmlentities($sch->row()->School_mark);?>">View Subjects</a>
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
