        ...
        $('#addschooltype').on('show.bs.modal', function (event) {
            ...
            $('select[name="school"]').change(function(){
              ...
              $('select[name="result_type"]').empty();
               ...
               $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/position/get_school_session/'+school,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
               ...
               $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/position/get_school_term/'+school,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
               ...
               $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/position/get_school_result_type/'+school,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
            ...
            $('select[name="class"]').change(function(){
              $('select[name="student"]').empty();
               ...
               $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/position/get_class_student/'+classs,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
    ...
    <script type="text/javascript">
        $('#edit_schooltype').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>teachers/position/get_position_id/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
