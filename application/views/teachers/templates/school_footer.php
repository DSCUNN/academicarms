    ...
    <script type="text/javascript">
        $('#edit_schooltype').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>account/schools/get_school_id/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
                        ...
                        $.each(data, function(key, value) {
                            stat=value.Status;
                            $('input[name="name"]').val(value.School_name);
                            $('input[name="url"]').val(value.School_url);
                            $('textarea[name="description"]').val(value.School_description);
                            $('input[name="id"]').val(value.School_id);
                        });
                    }
                });
            }
