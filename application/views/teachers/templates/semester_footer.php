<!-- BEGIN: Footer-->
    ...
    <script type="text/javascript">
        $('#addschooltype').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-title').text('Add new Academic Semester')
    ...
    <script type="text/javascript">
        $('#edit_schooltype').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this)
            modal.find('.modal-title').text('Edit Academic Semester')
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>account/semester/get_semester_id/'+recipient,
                    type: "GET",
                    dataType: "json",
    ...
    <script type="text/javascript">
        $('#delete_schooltype').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this)
            modal.find('.modal-title').text('Delete Academic Semester')
            $('input[name="id"]').val(recipient);
        })
    </script>
<script type="text/javascript">
