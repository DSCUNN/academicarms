    ...
    <script type="text/javascript">
        $('#edit_schooltype').on('show.bs.modal', function (event) {
            ...
            if(recipient) 
            {
                $.ajax(
                {
                    url: '<?php echo base_url();?>account/teachers/get_teacher_id/'+recipient,
                    type: "GET",
                    dataType: "json",
                    success:function(data) 
                    {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('input[name="id"]').val(value.Teacher_id);
                        });
                    }
                });
            }
...
<script type="text/javascript">
  $(document).ready(function() {
    var namefield='<div class="col-sm-4 form-group mb-4"><input class="form-control" type="text" placeholder="Teacher Name" name="name[]"></div>';
    var emailfield='<div class="col-sm-4 form-group mb-4"><input class="form-control" type="text" placeholder="Teacher Email" name="email[]"></div>';
    var passwordfield='<div class="col-sm-4 form-group mb-4"><input class="form-control" type="password" placeholder="Teacher Password" name="password[]"></div>';
