            ...
            <div>
                <div class="card">
                    ...
                    <div class="card-body pt-1">
                        ...
                        <p class="mb-4 text-center">Enter the code sent to your email here.</p>
                        <?php echo form_open('',' id="reset-password-form"');?>
                            <div class="md-form mb-0"><input class="md-form-control" type="password" name="code"><label>Code</label></div><button class="btn btn-primary btn-rounded btn-block mt-4">Authorize</button>
                        <?php echo form_close();?>
                    </div>
                </div>
