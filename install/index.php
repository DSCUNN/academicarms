<?php 
    ...
    $path = [
        ...
        'constant_path'       => 'php/constants.php',
        'flutterwave_path'       => 'php/flutterwave.php',
        'constant_output_path'  =>'../application/config/constants.php',
        'flutterwave_output_path'  =>'../application/config/flutterwave.php'
    ];
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($Validation->run($_POST)===true) {
            //check install.sql file is in sql directory
            if ($Validation->checkFileExists($path['sql_path'])==false) {
                $message .= "<li>install.sql file is not in sql/ directory!</li>";
            } else {
                ...
                }elseif ($FileWrite->Flutterwave($path,$_POST) === false) {
                    //write config file
                    $message .= "<li>The flutterwave  file could not be written, ";
                    $message .= "please chmod application/config/flutterwave.php file to 777</li>";
                }elseif ($FileWrite->Paystack($path,$_POST) === false) {
                    //write config file
                    $message .= "<li>The constants  file could not be written, ";
                    $message .= "please chmod application/config/constants.php file to 777</li>";
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> WEB APPLICATION INSTALLER</h1>
                    </div>
                    ...
                    <div class="app_footer"> 
                        <h3>Developed by bdtask and Used By Kopium Tech with Permission</h3>
                    </div>
                </div>
                <?php 
                } 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> ACADEMICA RMS</h1>
                    </div>
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form action="#" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label for="database">Paystack Public key </label>
                                        <input type="text" name="paystack_public" class="form-control" id="database"  value="<?= (!empty($_POST['paystack_public'])?$_POST['paystack_public']:null) ?>">
                                    </div> 
                                    <div class="form-group">
                                        <label for="username">Paystack Private Key </label>
                                        <input type="text" name="paystack_private" class="form-control" id="username"  value="<?= (!empty($_POST['paystack_private'])?$_POST['paystack_private']:null) ?>">
                                    </div> 
                                    <div class="form-group">
                                        <label for="password">Flutterwave Public Key </label>
                                        <input type="text" name="flutter_public" class="form-control" id="password"  value="<?= (!empty($_POST['flutter_public'])?$_POST['flutter_public']:null) ?>">
                                    </div>  
                                    <div class="form-group">
                                        <label for="hostname">Flutterwave Secret Key </label>
                                        <input type="text" name="flutter_private" class="form-control" id="hostname"   value="<?= (!empty($_POST['flutter_private'])?$_POST['flutter_private']:null) ?>">
                                    </div>  
                                    <div class="form-group">
                                        <label for="hostname">Environment </label>
                                        <select class="form-control" name="environ">
                                            <option value="FALSE" selected="">Live</option>
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> Result Manager Installer</h1>
                    </div>
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
