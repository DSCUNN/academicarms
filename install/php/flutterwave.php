...
$config['sandbox'] = {ENVIRONMENT}; //TRUE for Sandbox - FALSE for live environment
...
$config['PBFPubKey'] = ($config['sandbox']) ? '{FLUTTER_PUB_KEY}' : '{FLUTTER_PUB_KEY}'; /* Public Key for Sandbox : Live */
$config['SECKEY'] = ($config['sandbox']) ? '{FLUTTER_SEC_KEY}' : '{FLUTTER_SEC_KEY}'; /* Secret Key for Sandbox : Live */
